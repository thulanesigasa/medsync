...
export default function AdminScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Tab Navigation handled by BottomTabBar */}
...
{/* -------------------- 5. MANAGE TAB (Doctors, Updates, Settings) -------------------- */}
        {activeTab === 'manage' && (
          <View style={styles.sectionGap}>
            <View style={styles.card}>
...
export default function AdminScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <BottomTabBar navigation={navigation} activeTab={activeTab} isAdmin={true} onTabPress={setActiveTab} />
